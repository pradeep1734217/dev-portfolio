...
Invoice builder with Material UI and PDF export  
🔗 [View Repo](https://github.com/pradeep1734217/angular-invoice-app)

### 🔒 Spring Boot API with JWT  
Secure REST API with token-based login  
🔗 [View Repo](https://github.com/pradeep1734217/springboot-jwt-api)
